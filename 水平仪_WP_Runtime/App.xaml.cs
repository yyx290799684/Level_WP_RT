...
namespace 水平仪_WP_Runtime
{
    ...
    public sealed partial class App : Application
    {
        ...
        {
            if (appSetting.Values.ContainsKey("pcX") == false)
            {
                appSetting.Values["pcX"] = 0;
                appSetting.Values["pcY"] = 0;
                appSetting.Values["pcZ"] = 0;
            }
            if(appSetting.Values.ContainsKey("showPF") == false)
            {
                appSetting.Values["showPF"] = true;
            }
        }
